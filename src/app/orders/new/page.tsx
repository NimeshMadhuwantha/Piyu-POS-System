...
export default function NewOrder() {
  ...
  return <>
    ...
    {!loading && orders.length >= MAX_COLLECTION_RECORDS ? <section className="card"><div className="capacity-warning"><AlertTriangle size={20}/><div><b>The {MAX_COLLECTION_RECORDS.toLocaleString()} order limit has been reached.</b><br/><span>Clear old yearly data before creating another order.</span></div></div><Link className="btn" href="/settings">Open Settings</Link></section> : <OrderForm/>}
  </>;
}
