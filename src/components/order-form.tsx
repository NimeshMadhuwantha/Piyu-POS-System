...
import { calculateItemsWeight, calculateLineSubtotal, calculateTotals, effectiveShippingCharge, formatLKR } from "@/lib/calculations";
...
export function OrderForm({ existing }: { existing?: Order }) {
  ...
  return <form onSubmit={handleSubmit(submit)} className="order-form">
    ...
    <section className="card">
      <h2 className="section-title">{existing ? "C" : "D"}. Shipping & payment</h2>
      ...
      <div className="grid-fields">
        ...
        <div className="shipping-summary"><span>Courier / company <b>{selectedShipping?.courier || values.shipping?.courier || "-"}</b></span><span>Total parcel weight <b>{totalWeight.toLocaleString()} g</b></span></div>
